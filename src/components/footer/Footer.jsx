    ...
    <footer className="w-full p-10 border-t border-(--border) mt-10 flex flex-col items-center gap-10">
      <div className="flex flex-row items-center gap-5 text-(--white) text-2xl cursor-pointer">
        <a
          ...
          target="_blank"
          className="hover:text-(--instagram) duration-100"
        >
          <FaInstagram />
        </a>
        <a
          ...
          target="_blank"
          className="hover:text-(--facebook) duration-100"
        >
          <FaFacebookSquare />
        </a>
        <a
          ...
          target="_blank"
          className="hover:text-(--tiktok) duration-100"
        >
          <AiFillTikTok />
        </a>
        <a
          ...
          target="_blank"
          className="hover:text-(--linkedin) duration-100"
        >
          <FaLinkedin />
        </a>
      </div>
